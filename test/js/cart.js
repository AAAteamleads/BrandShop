...
let title = document.querySelector('.products__title'); // Получаем название товара
let price = 0; //итоговое число которое будет пересчитываться
let count = 1; // кол во товара по умолчанию
let allProducts = []; // Складываем сюда наши продукты в массив
